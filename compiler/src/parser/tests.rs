...
fn html_text_accepts_valid_input() {
  assert_eq!(html_text("abcdefg").unwrap(), ("", HTMLChild::Text("abcdefg".to_string())));
  assert_eq!(html_text("abc def ghi - - i").unwrap(), ("", HTMLChild::Text("abc def ghi - - i".to_string())));
  assert_eq!(html_text("123456789$#%&^(").unwrap(), ("", HTMLChild::Text("123456789$#%&^(".to_string())));
  assert_eq!(html_text("    ").unwrap(), ("", HTMLChild::Text("    ".to_string())));
}
...
fn attr_val_doub_str_valid_parse() {
  assert_eq!(attribute_value_double_string("\"asdfwre$%\"").unwrap(), ("", HTMLValue::String("asdfwre$%".to_string())));
  assert_eq!(attribute_value_double_string("\"1234567890!@#$%^&*()-+{}\\/?<>:\"").unwrap(), ("", HTMLValue::String("1234567890!@#$%^&*()-+{}\\/?<>:".to_string())));
  assert_eq!(attribute_value_double_string("\"''''\"").unwrap(), ("", HTMLValue::String("''''".to_string())));
  assert_eq!(attribute_value_double_string("\"    \"").unwrap(), ("", HTMLValue::String("    ".to_string())));
}
...
fn attr_val_sing_str_valid_parse() {
  assert_eq!(attribute_value_single_string("'asdfwre$%'").unwrap(), ("", HTMLValue::String("asdfwre$%".to_string())));
  assert_eq!(attribute_value_single_string("'1234567890!@#$%^&*()-+{}\\/?<>:'").unwrap(), ("", HTMLValue::String("1234567890!@#$%^&*()-+{}\\/?<>:".to_string())));
  assert_eq!(attribute_value_single_string("'\"'").unwrap(), ("", HTMLValue::String("\"".to_string())));
  assert_eq!(attribute_value_single_string("'    '").unwrap(), ("", HTMLValue::String("    ".to_string())));
}
...
fn attribute_value_parses_double_string() {
  assert_eq!(attribute_value("\"asdfasdf\"").unwrap(), ("", HTMLValue::String("asdfasdf".to_string())));
}
...
fn attribute_name_parses_valid_name() {
  assert_eq!(attribute_name("asdfasdf-asdfasdf").unwrap(), ("", "asdfasdf-asdfasdf".to_string()));
  assert_eq!(attribute_name("12345").unwrap(), ("", "12345".to_string()));
  assert_eq!(attribute_name("asdfasdf <").unwrap(), (" <", "asdfasdf".to_string()));
  assert_eq!(attribute_name("!@#$%^&*()_+").unwrap(), ("", "!@#$%^&*()_+".to_string()));
}
